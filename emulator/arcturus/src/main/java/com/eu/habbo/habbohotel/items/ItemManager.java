...
public class ItemManager {
    ...
    protected void loadItemInteractions() {
        ...
        this.interactionsList.add(new ItemInteraction("soundmachine", InteractionJukeBox.class));
        this.interactionsList.add(new ItemInteraction("traxmachine", InteractionJukeBox.class));
        this.interactionsList.add(new ItemInteraction("trax_machine", InteractionJukeBox.class));
