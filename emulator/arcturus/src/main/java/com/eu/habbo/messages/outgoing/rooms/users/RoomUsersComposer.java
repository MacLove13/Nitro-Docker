...
public class RoomUsersComposer extends MessageComposer {
    ...
    protected ServerMessage composeInternal() {
        ...
        if (this.habbo != null) {
            ...
            this.response.appendInt(this.habbo.getHabboInfo().getHealth());
            this.response.appendInt(this.habbo.getHabboInfo().getStamina());
            ...
            for (Habbo habbo : this.habbos) {
                if (habbo != null) {
                    ...
                    this.response.appendBoolean(true);
                    this.response.appendInt(habbo.getHabboInfo().getHealth());
                    this.response.appendInt(habbo.getHabboInfo().getStamina());
                }
            }
