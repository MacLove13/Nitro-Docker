...
if (!$https) {
	$texts = str_replace("[CDN_IMAGES]", "[HTTP_TAG]://shkw4ever.classichabbo.com/c_images/", $texts);
} else {
...
$texts = str_replace("[SSL_DOMAIN]", ($https ? "cdn.classichabbo.com" : "shkw4ever.classichabbo.com"), $texts);
