...
import { Column, Flex, LayoutAvatarImageView, LayoutBadgeImageView, LayoutProgressBar, Text, UserProfileIconView } from '../../../../../common';
...
export const InfoStandWidgetUserView: FC<InfoStandWidgetUserViewProps> = props =>
{
    ...
    const health = Math.max(0, Math.min(100, avatarInfo?.health ?? 100));
    const stamina = Math.max(0, Math.min(100, avatarInfo?.stamina ?? 100));
