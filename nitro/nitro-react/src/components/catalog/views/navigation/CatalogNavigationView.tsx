...
export const CatalogNavigationView: FC<CatalogNavigationViewProps> = props =>
{
    ...
    return (
        <Column fullHeight className="nitro-catalog-navigation-panel" gap={ 1 }>
            <CatalogSearchView />
            <Column fullHeight className="nitro-catalog-navigation-grid-container rounded p-1" overflow="hidden">
                <AutoGrid id="nitro-catalog-main-navigation" gap={ 0 } columnCount={ 1 } className="nitro-catalog-navigation-list">
