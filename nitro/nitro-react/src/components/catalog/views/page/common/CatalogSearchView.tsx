...
export const CatalogSearchView: FC<{}> = props =>
{
    ...
    return (
        <Flex className="nitro-catalog-search" position="relative">
            <input
                type="text"
                className="form-control form-control-sm nitro-catalog-search-input"
                placeholder={ LocalizeText('generic.search') }
                value={ searchValue }
                onChange={ event => setSearchValue(event.target.value) }
            />
            { (!searchValue || !searchValue.length)
                ? <FaPencilAlt className="nitro-catalog-search-icon fa-icon" />
                : <FaTimes
                    className="nitro-catalog-search-icon fa-icon clickable"
