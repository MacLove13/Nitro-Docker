                ...
                <NitroCardView uniqueKey="catalog" className="nitro-catalog" style={ GetConfiguration('catalog.headers') ? { width: 710 } : {} }>
                        ...
                        { rootNode && (rootNode.children.length > 0) && rootNode.children.map(child =>
                        {
                            ...
                            return (
                                <NitroCardTabsItemView key={ child.pageId } isActive={ child.isActive } onClick={ event =>
                                {
                                    ...
                                    activateNode(child);
                                } } className="nitro-catalog-tab-item">
                                    <Flex gap={ GetConfiguration('catalog.tab.icons') ? 1 : 0 } alignItems="center" className="nitro-catalog-tab-content">
                                        { GetConfiguration('catalog.tab.icons') && <CatalogIconView icon={ child.iconId } /> }
                                        <span className="nitro-catalog-tab-label">{ child.localization }</span>
                                    </Flex>
                    ...
                    <NitroCardContentView className="nitro-catalog-content">
                        <Grid className="nitro-catalog-main-grid">
                            ...
                            <Column size={ !navigationHidden ? 8 : 12 } overflow="hidden" className="nitro-catalog-page-column">
