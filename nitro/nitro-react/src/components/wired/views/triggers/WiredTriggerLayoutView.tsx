...
import { WiredTriggerUserVariableChangedView } from './WiredTriggerUserVariableChangedView';
...
export const WiredTriggerLayoutView = (code: number) =>
{
    switch(code)
    {
        ...
        case WiredTriggerLayout.USER_VARIABLE_CHANGED:
            return <WiredTriggerUserVariableChangedView />;
    }
